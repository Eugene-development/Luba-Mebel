  ...
  <div class="relative py-16 bg-white overflow-hidden">
    ...
    <div class="relative px-4 sm:px-6 lg:px-8">
      <div class="text-lg max-w-prose mx-auto">
        <h1>
          <span class="mt-2 block text-3xl text-center leading-8 font-extrabold tracking-tight text-main sm:text-4xl">Оплата заказов</span>
        </h1>
        <p class="mt-8 text-xl text-gray-500 leading-8">Вы можете произвести оплату удобным для вас способом:</p>
      </div>
      <div class="mt-6 prose prose-indigo prose-lg text-gray-500 mx-auto">
        <ul>
          <li><b>Наличный расчёт.</b> </li>
          <li><b>Банковская карта.</b> </li>
          <li><b>Безналичный рассчёт.</b> </li>
        </ul>
        <!--        <h3>Ждём вас!!!</h3>-->
        <figure>

      ...
      <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        <div class="xl:grid xl:grid-cols-3 xl:gap-8">
          <div class="space-y-6 xl:col-span-1">
            ...
            <div class="text-gray-500 text-base flex space-x-6">
              Инстаграм:
              <a
                href="https://www.instagram.com/lubaymebel52"
                class="text-gray-400 hover:text-gray-500"
                target="_blank"
              >
                <span class="sr-only">Instagram</span>
                <svg class="ml-2 h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <div class="mt-12 grid grid-cols-2 gap-8 xl:mt-0 xl:col-span-2">
            <div class="md:grid md:grid-cols-2 md:gap-8">
              <div>
                <h3 class="text-base font-semibold text-main tracking-wider uppercase">
                  Продукция
                </h3>
        ...
        <div class="mt-12 border-t border-gray-200 pt-8">
          <p class="text-base text-gray-400 xl:text-center">
            &copy; 2020-2021 Компания "ЛюбаMебель".
          </p>
        </div>
      </div>
    </footer>
